...
import PyMultiprocessTools.utils
from PyMultiprocessTools.utils import wait_lock, Worker, Pool, __PyMultiDec, ProcessTaskQueue
...
class ProcessPool(Pool):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if 'maxWorkers' not in kwargs:
            kwargs.update({'maxWorkers': math.ceil(PyMultiprocessTools.utils.get_cpu_count() / 2)})
